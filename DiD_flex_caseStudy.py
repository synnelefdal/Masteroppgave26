...
data_NO1_mNP = pd.concat( [data_NO5_NPoct], ignore_index=True)
data_NO1_mNP_1 = pd.concat([data_NO5_NPoct], ignore_index=True)
data_NO1_mNP_2 = pd.concat( [data_NO5_NPoct], ignore_index=True)

data_NO1_rest = pd.concat([data_NO5_NPnov,data_NO5_NPdec,data_NO5_NPjan,data_NO5_NPfeb,data_NO5_NPmars,data_NO5_NPapril], ignore_index=True)
data_NO1_rest_1 = pd.concat([data_NO5_NPfeb, data_NO5_NPmars,data_NO5_NPapril] , ignore_index=True)
data_NO1_rest_2 = pd.concat([data_NO5_NPapril], ignore_index=True)

# ------------- Januar ------------- #

data_NO1_mNP_3 = pd.concat( [data_NO5_NPjan], ignore_index=True)
data_NO1_mNP_4 = pd.concat([data_NO5_NPjan], ignore_index=True)
data_NO1_mNP_5 = pd.concat( [data_NO5_NPjan], ignore_index=True)

data_NO1_rest_3 = pd.concat([data_NO5_NPnov,data_NO5_NPdec,data_NO5_NPfeb,data_NO5_NPmars,data_NO5_NPapril], ignore_index=True)
data_NO1_rest_4 = pd.concat([data_NO5_NPfeb, data_NO5_NPmars,data_NO5_NPapril] , ignore_index=True)
data_NO1_rest_5 = pd.concat([data_NO5_NPapril], ignore_index=True)

# ------------- Mars ------------- #

data_NO1_mNP_6 = pd.concat( [data_NO5_NPmars], ignore_index=True)
data_NO1_mNP_7 = pd.concat([data_NO5_NPmars], ignore_index=True)
data_NO1_mNP_8 = pd.concat( [data_NO5_NPmars], ignore_index=True)

data_NO1_rest_6 = pd.concat([data_NO5_NPnov,data_NO5_NPdec,data_NO5_NPjan,data_NO5_NPfeb,data_NO5_NPapril], ignore_index=True)
data_NO1_rest_7 = pd.concat([data_NO5_NPfeb, data_NO5_NPapril] , ignore_index=True)
data_NO1_rest_8 = pd.concat([data_NO5_NPapril], ignore_index=True)

# ------------------------------------ STOPP AV ENDRING HER, DONT TOUCH ------------------------------------ #

results_NO1_okt, results_NO1_temp_okt = Difference_in_Difference_Flex(data_NO1_mNP, data_NO5_uNP, data_NO1_rest, Temp_Bergen, 'NO5', start_date_before_okt, end_date_before_okt, start_date_after_okt, end_date_after_okt)
results_NO1_jan, results_NO1_temp_jan = Difference_in_Difference_Flex(data_NO1_mNP_1, data_NO5_uNP, data_NO1_rest_1, Temp_Bergen, 'NO5', start_date_before_jan, end_date_before_jan, start_date_after_jan, end_date_after_jan)
results_NO1_mars, results_NO1_temp_mars = Difference_in_Difference_Flex(data_NO1_mNP_2, data_NO5_uNP, data_NO1_rest_2, Temp_Bergen, 'NO5', start_date_before_mars, end_date_before_mars, start_date_after_mars, end_date_after_mars)

results_NO1_okt_1, results_NO1_temp_okt_1 = Difference_in_Difference_Flex(data_NO1_mNP_3, data_NO5_uNP, data_NO1_rest_3, Temp_Bergen, 'NO5', start_date_before_okt, end_date_before_okt, start_date_after_okt, end_date_after_okt)
results_NO1_jan_1, results_NO1_temp_jan_1 = Difference_in_Difference_Flex(data_NO1_mNP_4, data_NO5_uNP, data_NO1_rest_4, Temp_Bergen, 'NO5', start_date_before_jan, end_date_before_jan, start_date_after_jan, end_date_after_jan)
results_NO1_mars_1, results_NO1_temp_mars_1 = Difference_in_Difference_Flex(data_NO1_mNP_5, data_NO5_uNP, data_NO1_rest_5, Temp_Bergen, 'NO5', start_date_before_mars, end_date_before_mars, start_date_after_mars, end_date_after_mars)

results_NO1_okt_2, results_NO1_temp_okt_2 = Difference_in_Difference_Flex(data_NO1_mNP_6, data_NO5_uNP, data_NO1_rest_6, Temp_Bergen, 'NO5', start_date_before_okt, end_date_before_okt, start_date_after_okt, end_date_after_okt)
results_NO1_jan_2, results_NO1_temp_jan_2 = Difference_in_Difference_Flex(data_NO1_mNP_7, data_NO5_uNP, data_NO1_rest_7, Temp_Bergen, 'NO5', start_date_before_jan, end_date_before_jan, start_date_after_jan, end_date_after_jan)
results_NO1_mars_2, results_NO1_temp_mars_2 = Difference_in_Difference_Flex(data_NO1_mNP_8, data_NO5_uNP, data_NO1_rest_8, Temp_Bergen, 'NO5', start_date_before_mars, end_date_before_mars, start_date_after_mars, end_date_after_mars)
...
fig.savefig("plot_casestudyNO5.png", dpi=300, bbox_inches = "tight")
