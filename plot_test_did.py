...
axes[0].axvspan(pd.Timestamp("2025-10-01"), pd.Timestamp("2026-01-31"), color = 'lightcoral', alpha = 0.15, zorder=0)
axes[0].grid(True)
...
axes[1].axvspan(pd.Timestamp("2025-10-01"), pd.Timestamp("2026-01-31"), color = 'lightcoral', alpha = 0.15, zorder=0)
axes[1].grid(True)
...
axes[2].axvspan(pd.Timestamp("2025-10-01"), pd.Timestamp("2026-01-31"), color = 'lightcoral', alpha = 0.15, zorder=0)
